...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_icon_head=findViewById(R.id.iv_icon_head);
        iv_icon_key=findViewById(R.id.iv_icon_key);
        requestPermissions();
        //找VideoView控件
        ...
        instance.doPost(urlTail, json, new OkHttpUtils.OkHttpCallBackLinener() {
            ...
            public void success(String json) {
                try {
                    ...
                    if (key_id != 0) {
                        iv_logo.setText("正在进入中...");
                        iv_logo.setTextSize(18);
                        edUserName.setVisibility(View.GONE);
                        edPassword.setVisibility(View.GONE);
                        btn_login.setVisibility(View.GONE);
                        tv_register.setVisibility(View.GONE);
                        iv_icon_head.setVisibility(View.GONE);
                        iv_icon_key.setVisibility(View.GONE);
